...
import { fetchRoomDensityMonthlyReport } from "../../service/apiServices";
import "bootstrap/dist/css/bootstrap.min.css";

const RoomDensityMonthly = () => {
                        ...
                        <thead>
                            <tr>
                                <th onClick={() => handleSort("roomName")}>
                                    Room Name {getSortIndicator("roomName")}
                                </th>
                                <th onClick={() => handleSort("totalDays")}>
                                    Total Days {getSortIndicator("totalDays")}
                                </th>
...
export default RoomDensityMonthly;
