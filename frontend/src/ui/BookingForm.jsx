...
const RoomBookingForm = () => {
    ...
    //             // Check for existing customer by ID number
    //             if (customer.idNumber?.trim()) {
    //                 existingCustomer = listCustomer.find(c => c.idNumber === customer.idNumber.trim());
    //             }
    ...
    //                 if (!response?.data?.success) {
    //                     throw new Error(`Failed to ${existingCustomer ? 'update' : 'create'} customer: ${customerData.fullName}`);
    //                 }
    //             } catch (error) {
    //                 console.error('Error processing customer:', error);
    //                 toast.error(`Failed to ${existingCustomer ? 'update' : 'create'} customer: ${customerData.fullName}`, { autoClose: 2000 });
    //                 return;
    //             }

    //             if (!customerId) {
    //                 throw new Error(`Could not get ID for customer: ${customer.fullName}`);
    //             }
